        ...
        <div class="col-md-8 col-lg-9 content-column white-background">
          ...
          <div class="manage_title">
              <div class="manage_title_content">
                  <div id="div1">发布新闻</div>
                  <div><p>管理新闻>发布新闻</p></div>
          </div>

          <div class="add_news" id="add_news1">

            <div class="add_news_title">
               <div><p>Add ： News-info</p></div>
            </div>

            <div class="add_news_wrapper">
                <form id="contact-form" method="post" action="doAddNews.jsp"  class="contact-form form">
                    <table id="publish_news-info">
                      ...
                      <tr>
                        ...
                        <td><textarea rows="4" cols="10"  name="content" id="content" required="required" class="form-control"></textarea></td>
                      </tr>
                  </table> 
                    <input type="submit" value="发布" id="submit" name="submit" class="btn btn-outline-primary btn-add">
                </form>
            </div>
