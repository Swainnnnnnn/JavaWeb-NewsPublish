...
<head>
  ...
  <link rel="stylesheet" href="css/news_manage/deleteNews.css">
        ...
        <div class="col-md-8 col-lg-9 content-column white-background">
          ...
          <div class="manage_title">
              <div class="manage_title_content">
                  <div id="div1">删除新闻</div>
                  <div><p>管理新闻>删除新闻</p></div>
          </div>

          <div class="del_news" id="del_news1">

            <div class="del_news_title">
               <div><p>Delete ： News-list</p></div>
            </div>
			...
			%>
              ...
              <form id="del_newslist" action="doDelNews.jsp" method="post" class="clearfix">
              <%
              ...
              %>                 
                ...
                <div class="newslist_news clearfix">
                  <div class="checkbox-id">
                    <input class="checkbox-id" type="checkbox" name="newsID" id="" value="<%= news.getId() %>">
                  </div>
                ...
                <%						
                  ...
                  %>
                   <input id="btn-delnews" type="submit" value="确认删除"/>
                <%
					}		
                %>
