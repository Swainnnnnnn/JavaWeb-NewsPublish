        ...
        <div class="col-md-8 col-lg-9 content-column white-background">
          ...
          <div class="manage_title">
          	...
          	<div class="del_news" id="del_news1">
				...
				%>
              			<form id="del_newslist" action="readNews.jsp" method="post" class="clearfix">
             			 <%
             			 ...
             			 %>                                 
				               <div class="newslist_news clearfix">     
				                  <div class="newslist_news_wrapper clearfix">
				                    ...
				                    <div id="news-info">
				                        <div id="news_title">
				                          <a href="detail.jsp?id=<%= news.getId() %>">
				                             <%= news.getTitle() %>   
				                          </a>
				                        </div>
				                        <div id="news_content">
				                          <p href="#?id=<%= news.getContent() %>">
				                             <%= news.getContent() %>
				                          </p>
				                        </div>				                
				                    </div>
